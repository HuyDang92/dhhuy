...
export default function NavBar() {
   ...
   return (
      <div className="px-5 lg:px-0 relative h-[40vh] lg:h-[75vh] mt-56 lg:mt-28" id="skills">
         ...
         <p
            data-aos="fade-up"
            className="text-center text-gray-400 text-sm lg:text-lg font-medium mb-10 lg:mb-16"
         >
            Frontend
         </p>
         <ul className="skills w-full flex justify-center space-x-2 lg:space-x-4 px-5 lg:px-0">
            <li data-aos="zoom-in">
         ...
         <ul className="skills w-full mt-3 lg:mt-0 flex justify-center space-x-2 lg:space-x-4">
            <li data-aos="zoom-in">
